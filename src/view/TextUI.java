...
=======
>>>>>>> 05fb2c1497c14223edef23be0563e9b1407a1625
...
public class TextUI {
  ...
  public static void main(String[] args) {
    ...
    while (playing) {
      ...
      if (boardController.isGameOver()) {
        System.out.println(
          ...
          currentUser.getName() +
          "! Your final score is: " +
          boardController.getCurrentScore()
        );
        playing = false;
      }
    }
    ...
    System.out.println(
      "Your current score is: " + boardController.getCurrentScore()
    );
    if (currentUser != null) {
      System.out.println(
        "Your highest score is: " + currentUser.getHighestScore()
      );
>>>>>>> 05fb2c1497c14223edef23be0563e9b1407a1625
    }
